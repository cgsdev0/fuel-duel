...
using System.Collections;
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_FuelLevel = 100f;            // how much fuel the plane has remaining
    ...
    public float Altitude { get; private set; }                     // The aeroplane's height above the ground.
        ...
        public float FuelLevel { get { return m_FuelLevel / startingFuel; } }    // The current fuel level
        ...
        public void Move(float rollInput, float pitchInput, float yawInput, float throttleInput, bool airBrakes)
        {
            ...
            m_FuelLevel -= EnginePower * Time.deltaTime;
            if(m_FuelLevel <= 0) {
                m_FuelLevel = 0;
                Immobilize();
            }
        ...
        private void CalculateForwardSpeed()
        {
            ...
            ForwardSpeed *= (transform.position.y <= -0.5f) ? 0.4f : 1;
    }
        ...
        private void CalculateDrag()
        {
            ...
            // increase drag if we're below the water
            extraDrag *= (transform.position.y <= -0.5f) ? 10 : 1;
        ...
        private void CalculateLinearForces()
        {
            ...
            if(!m_Immobilized) forces += liftPower*liftDirection;
            else forces -= liftPower * liftDirection;
        ...
        public void Immobilize()
        {
            ...
            v.y = Mathf.Min(v.y, -80f);
            v.x = 0f;
            v.z = 0f;
            m_Rigidbody.velocity = v;
            GetComponentInChildren<TrailScript>().stopped = true;
            m_Immobilized = true;
        }
